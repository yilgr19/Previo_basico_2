<main class="mx-auto w-full max-w-7xl flex-1 px-4 pb-12 sm:px-6 lg:px-8">
  <section class="mb-8 rounded-xl border-l-4 border-academic bg-gradient-to-r from-blue-50 to-white p-6 shadow-sm">
    ...
    <p class="mt-2 text-sm text-gray-500">Solicitudes en trámite: <strong class="text-gray-800"><?= (int) ($nActivas ?? 0) ?></strong> · Aprobadas: <strong class="text-gray-800"><?= (int) ($nAprobadas ?? 0) ?></strong></p>
  </section>

  <h2 class="mb-4 text-lg font-semibold text-gray-800">Accesos</h2>
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
    <a href="<?= h(url('estudiante/solicitudes.php')) ?>" class="group rounded-xl border border-gray-100 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      ...
      <strong class="block text-center text-gray-900">Solicitudes</strong>
      <span class="mt-1 block text-center text-xs text-gray-500">Radicar nueva y consultar el estado</span>
    </a>
