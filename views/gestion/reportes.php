...
<main class="flex-1 w-full mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
  ...
  <p class="mb-6 text-sm text-gray-600">Consulte lo registrado. Para <strong>crear o editar</strong> estudiantes use la tarjeta del panel principal.</p>
                    ...
                    <?php foreach ($listaEst as $e): ?>
                      <tr class="hover:bg-gray-50/80">
                        ...
                        <td class="px-3 py-2 text-right">
                          <a class="inline-flex rounded-lg border border-blue-600 px-2.5 py-1 text-xs font-medium text-blue-700 hover:bg-blue-50" href="<?= h(url('gestion/estudiantes?editar=' . (int) $e['id_estudiante'])) ?>">Editar</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
