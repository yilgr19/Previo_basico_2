  ...
  <div class="mx-auto w-full max-w-md">
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg">
      <div class="p-6 sm:p-8">
        ...
        <p class="mb-6 text-center text-sm text-gray-600">Estudiante: indique documento y correo tal como están registrados.</p>
        <?php if ($error): ?>
        ...
        <p class="mt-6 text-center text-sm">
          <a href="<?= h(url('login')) ?>" class="font-medium text-academic hover:underline">Volver al inicio de sesión</a>
        </p>
      </div>
    </div>
  </div>
