...
<nav class="mb-6 flex flex-wrap gap-2 rounded-xl border border-gray-200 bg-white p-2 shadow-sm" aria-label="Solicitudes">
  <a href="<?= h(url('docente/nueva_solicitud.php')) ?>" class="<?= h($nuevaCls) ?>">Nueva solicitud</a>
  <a href="<?= h(url('docente/mis_solicitudes.php')) ?>" class="<?= h($listaCls) ?>">Mis solicitudes</a>
</nav>
