...
$progTpSop = programa_label_by_id(123);
$progOc127 = programa_label_by_id(127);
$progOc128 = programa_label_by_id(128);
$progOc130 = programa_label_by_id(130);
$progOc131 = programa_label_by_id(131);

/** Docentes 1–5: Cúcuta. 6–10: Ocaña. */
$docentes = [
    [
        'id_docente' => 1,
        ...
        'telefono' => '3001112233',
        'id_sede' => $idSedeCucuta,
        'id_programa' => 121,
        'programa' => $progDg,
        'codigo_empleado' => 'EMP-CC-5001',
        'unidad_academica' => 'Cúcuta — Facultad de Diseño',
    ...
    [
        ...
        'id_programa' => 124,
        'programa' => $progTds,
        'codigo_empleado' => 'EMP-CC-5002',
        'unidad_academica' => 'Cúcuta — Ingeniería de sistemas',
    ...
    [
        ...
        'id_programa' => 121,
        'programa' => $progDg,
        'codigo_empleado' => 'EMP-CC-5003',
        'unidad_academica' => 'Cúcuta — Área gráfica',
    ...
    [
        ...
        'id_programa' => 124,
        'programa' => $progTds,
        'codigo_empleado' => 'EMP-CC-5004',
        'unidad_academica' => 'Cúcuta — Laboratorios',
        'categoria_docente' => 'asociado',
    ...
    [
        ...
        'id_programa' => 121,
        'programa' => $progDg,
        'codigo_empleado' => 'EMP-CC-5005',
        'unidad_academica' => 'Cúcuta — Taller diseño',
        'categoria_docente' => 'asociado',
        'tipo_contrato' => 'tiempo_completo',
        'clave' => 'demo123',
    ],
    [
        ...
        'apellido' => 'Pardo',
        'documento' => '212001',
        'correo' => 'r.pardo.ocana@universidad.edu.co',
        'telefono' => '3011112233',
        'id_sede' => $idSedeOcana,
        'id_programa' => 128,
        'programa' => $progOc128,
        'codigo_empleado' => 'EMP-OC-6001',
        'unidad_academica' => 'Extensión Ocaña — Diseño y comunicación visual',
        'categoria_docente' => 'asociado',
        'tipo_contrato' => 'tiempo_completo',
        'clave' => 'demo123',
    ],
    [
        ...
        'apellido' => 'Fuentes',
        'documento' => '212002',
        'correo' => 'm.fuentes.ocana@universidad.edu.co',
        'telefono' => '3012223344',
        'id_sede' => $idSedeOcana,
        'id_programa' => 127,
        'programa' => $progOc127,
        'codigo_empleado' => 'EMP-OC-6002',
        'unidad_academica' => 'Extensión Ocaña — Contenidos gráficos y multimedia',
        'categoria_docente' => 'titular',
        'tipo_contrato' => 'tiempo_completo',
        'clave' => 'demo123',
    ],
    [
        ...
        'apellido' => 'Leal',
        'documento' => '212003',
        'correo' => 'h.leal.ocana@universidad.edu.co',
        'telefono' => '3013334455',
        'id_sede' => $idSedeOcana,
        'id_programa' => 128,
        'programa' => $progOc128,
        'codigo_empleado' => 'EMP-OC-6003',
        'unidad_academica' => 'Extensión Ocaña — Taller gráfico',
        'categoria_docente' => 'asistente',
        'tipo_contrato' => 'medio_tiempo',
        'clave' => 'demo123',
    ],
    [
        ...
        'apellido' => 'Buitrago',
        'documento' => '212004',
        'correo' => 'c.buitrago.ocana@universidad.edu.co',
        'telefono' => '3014445566',
        'id_sede' => $idSedeOcana,
        'id_programa' => 130,
        'programa' => $progOc130,
        'codigo_empleado' => 'EMP-OC-6004',
        'unidad_academica' => 'Extensión Ocaña — Negocios internacionales',
        'categoria_docente' => 'asociado',
        'tipo_contrato' => 'catedra',
        'clave' => 'demo123',
    ],
    [
        'id_docente' => 10,
        'nombre' => 'Edwin Giovanny',
        'apellido' => 'Silva',
        'documento' => '212005',
        'correo' => 'e.silva.ocana@universidad.edu.co',
        'telefono' => '3015556677',
        'id_sede' => $idSedeOcana,
        'id_programa' => 131,
        'programa' => $progOc131,
        'codigo_empleado' => 'EMP-OC-6005',
        'unidad_academica' => 'Extensión Ocaña — Administración y emprendimiento',
        'categoria_docente' => 'asociado',
        'tipo_contrato' => 'tiempo_completo',
        'clave' => 'demo123',
    ],
...
/** Estudiantes 1–5: Cúcuta. 6–10: Ocaña. */
$estudiantes = [
    [
        'id_estudiante' => 1,
    ...
    [
        ...
        'nombre' => 'Valentina',
        'apellido' => 'Rincón',
        'correo' => 'v.rincon.ocana@estudiante.edu.co',
        'sexo' => 'F',
        'id_programa' => 128,
        'programa' => $progOc128,
        'estado_academico' => 'REGULAR',
    ...
    [
        ...
        'nombre' => 'Jhon Jairo',
        'apellido' => 'Patiño',
        'correo' => 'j.patino.ocana@estudiante.edu.co',
        'sexo' => 'M',
        'id_programa' => 127,
        'programa' => $progOc127,
        'estado_academico' => 'REGULAR',
        'semestre' => 3,
        'fecha_nacimiento' => '2004-03-18',
        'edad' => 21,
        'direccion' => 'Calle 14 #8-33',
        'barrio' => 'La Esperanza',
        'telefono' => '3101002007',
        'id_sede' => $idSedeOcana,
        'id_jornada' => 1,
    ...
    [
        ...
        'nombre' => 'Natalia',
        'apellido' => 'Ordóñez',
        'correo' => 'n.ordonez.ocana@estudiante.edu.co',
        'sexo' => 'F',
        'id_programa' => 128,
        'programa' => $progOc128,
        'estado_academico' => 'REGULAR',
        'semestre' => 2,
        'fecha_nacimiento' => '2005-09-22',
        'edad' => 20,
        'direccion' => 'Vereda Alto de la Palma',
        'barrio' => 'Rural Ocaña',
        'telefono' => '3101002008',
        'id_sede' => $idSedeOcana,
        'id_jornada' => 2,
    ...
    [
        ...
        'nombre' => 'Óscar David',
        'apellido' => 'Montes',
        'correo' => 'o.montes.ocana@estudiante.edu.co',
        'sexo' => 'M',
        'id_programa' => 130,
        'programa' => $progOc130,
        'estado_academico' => 'REGULAR',
        ...
        'edad' => 19,
        'direccion' => 'Mz B Casa 7, conjunto La Pradera',
        'barrio' => 'Mutiscua',
        'telefono' => '3101002009',
        'id_sede' => $idSedeOcana,
        'id_jornada' => 1,
    ...
    [
        ...
        'nombre' => 'Luz Angela',
        'apellido' => 'Cáceres',
        'correo' => 'l.caceres.ocana@estudiante.edu.co',
        'sexo' => 'F',
        'id_programa' => 131,
        'programa' => $progOc131,
        'estado_academico' => 'REGULAR',
        ...
        'edad' => 23,
        'direccion' => 'Avenida Gran Colombiano km 2',
        'barrio' => 'La Mariela',
        'telefono' => '3101002010',
        'id_sede' => $idSedeOcana,
        'id_jornada' => 1,
